...
<head>
    <meta charset="UTF-8">
    <title><spring:message code="etms.administration.new-problem.title" text="New Problem"/></title>
    <!-- StyleSheets -->
                ...
                <div class="row-fluid">
                    <div class="span8">
                        ...
                        <div class="control-group row-fluid">
                            <label for="problem-name"><spring:message code="etms.administration.new-problem.problem-name"
                                                                      text="Problem Name"/></label>
                            <input id="problem-name" class="span12" type="text" maxlength="128"/>
                        </div> <!-- .control-group -->
                        <div class="control-group row-fluid">
                            <label for="time-limit"><spring:message code="etms.administration.new-problem.time-limit"
                                                                    text="Time Limit"/> (ms)</label>
                            <input id="time-limit" class="span12" type="text" maxlength="8"/>
                        </div> <!-- .control-group -->
                        <div class="control-group row-fluid">
                            <label for="memory-limit"><spring:message code="etms.administration.new-problem.memory-limit"
                                                                      text="Memory Limit"/> (KB)</label>
                        ...
                        <h4><spring:message code="etms.administration.new-problem.input-output"
                                            text="Input / Output"/></h4>
                        <div class="control-group row-fluid">
                            <label for="input-format"><spring:message code="etms.administration.new-problem.input-format"
                                                                      text="Input Format"/></label>
                            <textarea id="input-format" class="span12"></textarea>
                        </div> <!-- .control-group -->
                        <div class="control-group row-fluid">
                            <label for="output-format"><spring:message
                                    code="etms.administration.new-problem.output-format" text="Output Format"/></label>
                            <textarea id="output-format" class="span12"></textarea>
                        </div> <!-- .control-group -->
                        <div class="control-group row-fluid">
                            <label for="input-sample"><spring:message code="etms.administration.new-problem.input-sample"
                                                                      text="Input Sample"/></label>
                            <textarea id="input-sample" class="span12"></textarea>
                        </div> <!-- .control-group -->
                        <div class="control-group row-fluid">
                            <label for="output-sample"><spring:message
                                    code="etms.administration.new-problem.output-sample" text="Output Sample"/></label>
                            <textarea id="output-sample" class="span12"></textarea>
                        </div> <!-- .control-group -->
                        <div class="row-fluid">
                            <div class="span6">
                                <h4><spring:message code="etms.administration.new-problem.test-cases"
                                                    text="Test Cases"/></h4>
                            </div> <!-- .span6 -->
                            <div class="span6 text-right">
                                <a id="new-test-case"
                                   title="<spring:message code="etms.administration.new-problem.new-test-case" text="New test case" />"
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                <div id="test-cases">
                                    <p id="no-test-cases"><spring:message
                                            code="etms.administration.new-problem.no-test-cases"
                                            text="No Test Cases."/></p>
                                    <ul></ul>
                                </div> <!-- #test-cases -->
                            </div> <!-- .span12 -->
                        </div> <!-- .row-fluid -->
                    ...
                    <div class="span4">
                        <div class="section">
                            <div class="header">
                                <h5><spring:message code="etms.administration.new-problem.create-problem"
                                                    text="Create Problem"/></h5>
                            </div> <!-- .header -->
                            <div class="body">
                                <div class="row-fluid">
                                    <div class="span8">
                                ...
                                <div class="row-fluid">
                                    <div class="span8">
                                        <spring:message code="etms.administration.new-problem.test-case-exactly-match"
                                                        text="Test Case Exactly Match"/>
                                    </div> <!--- .span8 -->
                                    <div class="span4 text-right">
                            ...
                            <div class="footer text-right">
                                <button class="btn btn-primary" type="submit"><spring:message
                                        code="etms.administration.new-problem.publish-problem" text="Publish"/></button>
                            </div> <!-- .footer -->
                        </div> <!-- .section -->
                        <div class="section">
                            <div class="header">
                                <h5><spring:message code="etms.administration.new-problem.problem-categories"
                                                    text="Categories"/></h5>
                            </div> <!-- .header -->
                            <div class="body">
                                <c:forEach var="entry" items="${problemCategories}">
                                    <ul class="parent-categories">
                                        <li>
                                            <label class="checkbox parent-category"
                                                   for="${entry.key.problemCategorySlug}">
                                                <input id="${entry.key.problemCategorySlug}" type="checkbox"
                                                       data-toggle="checkbox"> ${entry.key.problemCategoryName}
                                            </label>
                                            <ul class="sub-categories">
                                                <c:forEach var="problemCategory" items="${entry.value}">
                                                    <li>
                                                        <label class="checkbox child-category"
                                                               for="${problemCategory.problemCategorySlug}">
                                                            <input id="${problemCategory.problemCategorySlug}"
                                                                   type="checkbox"
                                                                   data-toggle="checkbox"> ${problemCategory.problemCategoryName}
                                                        </label>
                                                    </li>
                                                </c:forEach>
                                            </ul>
...
<script type="text/javascript">
    function getTestCaseContainer(testCaseId) {
        var containerTemplate = '<li class="test-case">' +
            '    <div class="header">' +
            '        <h5><spring:message code="etms.administration.new-problem.test-case" text="Test Case" /> #%s</h5>' +
            '        <ul class="inline">' +
            ...
            '        <div class="row-fluid">' +
            '            <div class="span4">' +
            '                <label><spring:message code="etms.administration.new-problem.standard-input" text="Standard Input" /></label>' +
            '            </div> <!-- .span4 -->' +
            '            <div class="span8">' +
            ...
            '        <div class="row-fluid">' +
            '            <div class="span4">' +
            '                <label><spring:message code="etms.administration.new-problem.standard-output" text="Standard Output" /></label>' +
            '            </div> <!-- .span4 -->' +
            '            <div class="span8">' +
...
<script type="text/javascript">
    $('#test-cases').on('click', 'i.fa-trash', function () {
        var testCaseContainer = $(this).parent().parent().parent().parent().parent(),
            ...
            testCaseName = '<spring:message code="etms.administration.new-problem.test-case" text="Test Case" /> #%s';
...
<script type="text/javascript">
    function onSubmit() {
        ...
        $('button[type=submit]', '#problem-form').html('<spring:message code="etms.administration.new-problem.please-wait" text="Please wait..." />');
    ...
    function processCreateProblemResult(result) {
        if (result['isSuccessful']) {
            ...
            if (!result['isTimeLimitLegal']) {
                errorMessage += '<spring:message code="etms.administration.new-problem.time-limit-illegal" text="The Time Limit should be an integer greater than 0." /><br>';
            }
            if (!result['isMemoryLimitLegal']) {
                errorMessage += '<spring:message code="etms.administration.new-problem.memory-limit-illegal" text="The Memory Limit should be an integer greater than 0." /><br>';
            }
            ...
            if (result['isInputFormatEmpty']) {
                errorMessage += '<spring:message code="etms.administration.new-problem.input-format-empty" text="You can&acute;t leave Input Format empty." /><br>';
            }
            if (result['isOutputFormatEmpty']) {
                errorMessage += '<spring:message code="etms.administration.new-problem.output-format-empty" text="You can&acute;t leave Output Format empty." /><br>';
            }
            if (result['isInputSampleEmpty']) {
                errorMessage += '<spring:message code="etms.administration.new-problem.input-sample-empty" text="You can&acute;t leave Input Sample empty." /><br>';
            }
            if (result['isOutputSampleEmpty']) {
                errorMessage += '<spring:message code="etms.administration.new-problem.output-sample-empty" text="You can&acute;t leave Output Sample empty." /><br>';
            }
        ...
        $('button[type=submit]', '#problem-form').html('<spring:message code="etms.administration.new-problem.publish-problem" text="Publish" />');
    }
</script>
</body>
</html>