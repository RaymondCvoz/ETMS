...
CREATE TABLE `etms_exam_participants` (
  ...
  `uid` bigint(20) DEFAULT NULL COMMENT '参与学生唯一标识符',
  KEY `etms_exam_participants_etms_exams_null_fk` (`exam_id`),
  KEY `etms_exam_participants_etms_users_null_fk` (`uid`),
  CONSTRAINT `etms_exam_participants_etms_exams_null_fk` FOREIGN KEY (`exam_id`) REFERENCES `etms_exams` (`exam_id`),
  CONSTRAINT `etms_exam_participants_etms_users_null_fk` FOREIGN KEY (`uid`) REFERENCES `etms_users` (`uid`)
...
-- Dump completed on 2022-12-30  9:54:46
